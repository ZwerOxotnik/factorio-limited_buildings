...
if remote.interfaces["limited_buildings"] then return end
if script.mod_name ~= "limited_buildings" and script.active_mods["limited_buildings"] then
	return
end
